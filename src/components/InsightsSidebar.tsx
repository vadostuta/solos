...
import { Lightbulb, ChevronDown, Settings2, ChevronLeft, ChevronRight } from 'lucide-react'
...
export function InsightsSidebar({ insights, onDismiss, selectedCategories, onCategoryToggle }: InsightsSidebarProps) {
  ...
  return (
    <aside className={`transition-all duration-300 ease-in-out ${isExpanded ? 'w-full lg:w-80' : 'w-12'} space-y-3`}>
      {isExpanded ? (
        <>
          {/* Header - Expanded */}
          <div className='flex items-center justify-between'>
            ...
            <div className='space-y-3'>
              <div>
                <h4 className='font-medium text-sm mb-2'>Filter Categories</h4>
